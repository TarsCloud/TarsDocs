...
- 关于 tars 的整体架构和设计理念，请阅读 [Tars 介绍](../../rumen/jian-jie.md)
...
- 要求 Go 1.9.x 或以上版本,请查看[https://golang.org/doc/install](https://golang.org/doc/install)

# <span id="main-chapter-2"></span>下载 tarsgo 代码
...
linux 下开发, 建议可以使用 cmake 来管理代码, [请参考](spec.md)
...
- 下面是一个完整的示例，用于说明如何使用 tarsgo 去构建服务端。

#### **接口定义**

在 $GOPATH/src 下编写一个 tars 文件，如 hello.tars , 比如 $GOPATH/src/TestApp/TestServer/hello.tars. 有关 tars 协议的更多详细信息, 请查看 [https://github.com/TarsCloud/TarsTup/blob/master/docs-en/tars_tup.md](https://github.com/TarsCloud/TarsTup/blob/master/docs-en/tars_tup.md)
